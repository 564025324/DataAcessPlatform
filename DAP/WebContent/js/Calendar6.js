...
//            self.opener.document." + this.gReturnItem + ".value='" + this.format_data(vDay) + 
            vCode = vCode + "onClick=\"javascript:window.close();window.opener.document.frm." + this.gReturnItem + ".value='"
            	+ this.format_data(vDay) + "';\">" + this.format_day(vDay) + "</A>" + "</TD>";
            vDay=vDay + 1;
        }
        vCode = vCode + "</TR>";
...
function show_calendar(elementName) {
        /* 
